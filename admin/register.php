...
<header>
    ...
    <div class="row">
        ...
        <div class="col-sm-3"><h2 class="animated rotateIn">+88-02-9140752 </h2></div>
 ...
 <!--header end-->
    ...
    <h2 class="v-center well"><label class="animated zoomIn">Author Sign Up</h2>
 ...
 <?php
       ...
       if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        //echo $passlength;
         ...
         $getauthor=$author->getauthors($userName,$userEmail);
        if($getauthor){

        while($result=$getauthor->fetch_assoc()){
