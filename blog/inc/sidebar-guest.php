   ...
   ?>
	...
	<li class="well"> <a href="guest-categoryWisePost.php?category=<?php echo $result['catId']?>"> <i class="fa fa-arrow-circle-o-right"></i><?php echo $result['name'];?></a></li>		
 ...
 <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p class=" thum-height " style="text-align:justify; padding:5px;">
         ...
         <br>
          <a href="guest-post-detail.php?id=<?php echo $result['id'];?>" class="btn btn-info pull-right" >Read More..</a>
